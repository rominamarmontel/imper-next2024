                  ...
                  <div className="HomePage-text-left">
                    ...
                    {isEnglish ? (
                      <p className="smartphone__area">
                        ...
                        produced in a context of formal freedom. Essential
                        support for independent works, Impermanence Films pools
                        and provides production and distribution tools.
                      </p>
                    ) : (
                      <p className="smartphone__area">
                  ...
                  <div className="HomePage-text-right">
                    {!isEnglish ? (
                      ...
                      <>
                        <ul>
                          <li>
                            <Link href="/en/films">ALL FILMS</Link>
                          </li>
                          <li>
                            <Link href="/en/about">ABOUT MPERMANENCE</Link>
                          </li>
                        </ul>
                      </>
                    )}
